...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-16 sm:pt-20">
      {/* Top Navigation Bar */}
      <div className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md border-b border-gray-200/50 px-3 sm:px-4 py-2 sm:py-3 z-50">
        <div className="max-w-4xl mx-auto flex items-center justify-between gap-2">
          ...
          <h1 className="text-lg sm:text-xl font-bold text-pink-800">{t('dashboard.title')}</h1>
          <div className="flex items-center gap-1 sm:gap-2">
            {isConnected && <ConnectButton compact />}
            <Button variant="outline" size="icon" onClick={handleRefetch} disabled={isLoading} className="h-8 w-8 sm:h-9 sm:w-9">
